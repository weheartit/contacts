Gem::Specification.new do |s|
  ...
  s.summary = "grab contacts from Yahoo, AOL, Gmail, Hotmail, Plaxo, GMX and Web.de"
  s.description = "A universal interface to grab contact list information from Yahoo, AOL, Gmail, Hotmail, Plaxo, GMX, Web.de. Now supporting Ruby 1.9."
